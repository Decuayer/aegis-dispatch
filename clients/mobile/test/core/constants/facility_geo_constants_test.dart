...
void main() {
  group('FacilityGeoConstants Tests', () {
    test('facilityBounds encompasses expected refinery coordinate boundaries', () {
    ...
    test('isWithinFacility returns false for points outside facility grounds', () {
    ...
    test('zoom constraint constants are properly configured', () {
      expect(FacilityGeoConstants.lockedMinZoom, greaterThan(FacilityGeoConstants.unlockedMinZoom));
      expect(FacilityGeoConstants.maxZoom, greaterThan(FacilityGeoConstants.lockedMinZoom));
    });
  });
}
